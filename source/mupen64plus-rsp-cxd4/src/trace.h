...
static char *signed_imm16(u32 op)
{
        static char temp[10];
        i16 value = op & 0xffff;
...
static void disasm_cop0(u32 op)
{
        int rt = (op >> 16) & 31;
        int rd = (op >> 11) & 31;
...
static void disasm_cop2(u32 op)
{
        int rt = (op >> 16) & 31;
        int rd = (op >> 11) & 31;
        int el = (op >> 21) & 0xf;
...
static void disasm_lwc2(u32 op)
{
        int dest = (op >> 16) & 0x1f;
        int base = (op >> 21) & 0x1f;
        int del = (op >> 7) & 0xf;
...
static void disasm_swc2(u32 op)
{
        int dest = (op >> 16) & 0x1f;
        int base = (op >> 21) & 0x1f;
        int del = (op >> 7) & 0xf;
...
static u32 rsp_dasm_one(char *buffer, u32 pc, u32 op)
{
        int rs = (op >> 21) & 31;
        int rt = (op >> 16) & 31;
        int rd = (op >> 11) & 31;
        ...
        switch (op >> 26)
        {
                ...
                case 0x01:              // REGIMM
                {
                        switch ((op >> 16) & 0x1f)
                        {
                                case 0x00:      print("bltz   %s, $%08X", reg[rs], pc + 4 + ((i16)op << 2)); break;
                                case 0x01:      print("bgez   %s, $%08X", reg[rs], pc + 4 + ((i16)op << 2)); break;
                                case 0x10:      print("bltzal %s, $%08X", reg[rs], pc + 4 + ((i16)op << 2)); break;
                                case 0x11:      print("bgezal %s, $%08X", reg[rs], pc + 4 + ((i16)op << 2)); break;
                ...
                case 0x04:      print("beq    %s, %s, $%08X", reg[rs], reg[rt], pc + 4 + ((i16)(op) << 2)); break;
                case 0x05:      print("bne    %s, %s, $%08X", reg[rs], reg[rt], pc + 4 + ((i16)(op) << 2)); break;
                case 0x06:      print("blez   %s, $%08X", reg[rs], pc + 4 + ((i16)(op) << 2)); break;
                case 0x07:      print("bgtz   %s, $%08X", reg[rs], pc + 4 + ((i16)(op) << 2)); break;
                ...
                case 0x0c:      print("andi   %s, %s, $%04X", reg[rt], reg[rs], (u16)(op)); break;
                case 0x0d:      print("ori    %s, %s, $%04X", reg[rt], reg[rs], (u16)(op)); break;
                case 0x0e:      print("xori   %s, %s, $%04X", reg[rt], reg[rs], (u16)(op)); break;
                case 0x0f:      print("lui    %s, %s, $%04X", reg[rt], reg[rs], (u16)(op)); break;
...
void TRACE(const char * s, ...) {
    ...
    fprintf(stderr, "f0=%x f1=%x f2=%x f3=%x\n", /*rsp.flag[0],
        rsp.flag[1],rsp.flag[2],rsp.flag[3]*/0,0,0,0);	//TODO where are the flags?
}
#endif
