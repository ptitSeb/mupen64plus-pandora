...
#ifdef HAVE_GLES0
#define RGBA5551_BlueMask2   (0xF800)
#define RGBA5551_GreenMask2 (0x07C0)
#define RGBA5551_RedMask2  (0x003E)
#define RGBA5551_AlphaMask2 (0x0001)


#define RGBA5551_BlueShift2   11
#define RGBA5551_GreenShift2 6
#define RGBA5551_RedShift2  1
#define RGBA5551_AlphaShift2 0

#define RGBA565_BlueMask2     (0xF800)
#define RGBA565_GreenMask2   (0x07E0)
#define RGBA565_RedMask2    (0x001F)

#define RGBA565_BlueShift2    11
#define RGBA565_GreenShift2  5
#define RGBA565_RedShift2   0
#else
#define RGBA5551_RedMask2   (0xF800)
#define RGBA5551_GreenMask2 (0x07C0)
#define RGBA5551_BlueMask2  (0x003E)
#define RGBA5551_AlphaMask2 (0x0001)


#define RGBA5551_RedShift2   11
#define RGBA5551_GreenShift2 6
#define RGBA5551_BlueShift2  1
#define RGBA5551_AlphaShift2 0

#define RGBA565_RedMask2     (0xF800)
#define RGBA565_GreenMask2   (0x07E0)
#define RGBA565_BlueMask2    (0x001F)

#define RGBA565_RedShift2    11
#define RGBA565_GreenShift2  5
#define RGBA565_BlueShift2   0
#endif
...
{
    uint32 dwRed   = FiveToEight[(w555&RGBA5551_RedMask2)  >> RGBA5551_RedShift2];
    uint32 dwGreen = FiveToEight[(w555&RGBA5551_GreenMask2)>> RGBA5551_GreenShift2];
    uint32 dwBlue  = FiveToEight[(w555&RGBA5551_BlueMask2) >> RGBA5551_BlueShift2];
    uint32 dwAlpha =             (w555&RGBA5551_AlphaMask2) ? 0xFF : 0x00;
