...
*/
#ifdef HAVE_GLES
static void myglMultiTexCoord2f(GLenum target, GLfloat s, GLfloat t)
{
	glMultiTexCoord4f(target, s, t, 0.0f, 1.0f);
}
static void myglMultiTexCoord2fv(GLenum target, const GLfloat *v)
{
...
#define    pglMultiTexCoord2f			myglMultiTexCoord2f
#define    pglMultiTexCoord2fv			myglMultiTexCoord2fv
#define    pglDeleteProgramsARB(a,b)		{}
#define    pglProgramStringARB(a,b,c,d)		{}
#define    pglBindProgramARB(a,b)		{}
#define    pglGenProgramsARB(a,b)		{}
#define    pglProgramEnvParameter4fvARB(a,b,c)	{}
#define    pglFogCoordPointerEXT(a,b,c)		{}
