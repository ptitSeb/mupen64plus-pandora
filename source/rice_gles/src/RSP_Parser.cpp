...
*/
	...
	if (skipping) {
		...
		//don't want to skip, but do it slowly too
		if (skipframe<oldskip-1)
			skipping = true;
	}*/
	if (skipping) {
...
// 	        numvi=0;
    ...
    // Check if we need to purge (every 5 milliseconds)	/*SEB maybe that's too frequent. Let's change 5 by 2*1000 = 2sec !*/
